...
import { Activity, BarChart3, Bot, Check, ChevronDown, FileText, Languages, LogOut, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Layers, Loader2, UserRound, ShieldCheck } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/admin", icon: ShieldCheck, label: t('layout.admin') },
