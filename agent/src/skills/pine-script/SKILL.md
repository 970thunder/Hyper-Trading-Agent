...
This skill exports a Hyper-Trading-Agent strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by Hyper-Trading-Agent
...
```mql5
//+------------------------------------------------------------------+
//| Generated by Hyper-Trading-Agent                                         |
//+------------------------------------------------------------------+
#property copyright "Hyper-Trading-Agent"
...
When generating code, map Hyper-Trading-Agent instrument codes appropriately:

| Hyper-Trading-Agent | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original Hyper-Trading-Agent run_id and instrument
