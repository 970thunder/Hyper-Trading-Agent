...
- 종목 메타데이터는 제공업체의 기업행동과 거래소 세션 캘린더를 제공합니다. 신뢰할 수 있는 기업행동 이력에는 여전히 공식 데이터 제공업체가 필요합니다.
- 시장 데이터 품질은 XNYS, XHKG, XSHG 거래일 캘린더를 적용하고 갭 주석과 신선도 SLA를 제공합니다. 정규화 로더에는 raw 가격만 실제 적용되며 전방 및 후방 조정은 아직 지원하지 않습니다.
