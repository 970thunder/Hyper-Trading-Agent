...
Output:
    ~/.hyper-trading-agent/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.hyper-trading-agent/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.hyper-trading-agent/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".hyper-trading-agent" / "reports"
