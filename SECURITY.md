...
2. Use the [GitHub Security Advisory](https://github.com/970thunder/Hyper-Trading-Agent/security/advisories/new) to report privately.
...
This policy applies to the [970thunder/Hyper-Trading-Agent](https://github.com/970thunder/Hyper-Trading-Agent) repository.
...
Hyper-Trading-Agent is an open-source finance **research** tool. We will **never** ask you to
...
- Our only official Discord is **https://discord.gg/6TdQnT5xcF** (the HKUDS community server,
  also linked from the README). Treat any other "Hyper-Trading-Agent" Discord as an impostor.
...
See the pinned security announcement in [Discussions](https://github.com/970thunder/Hyper-Trading-Agent/discussions)
