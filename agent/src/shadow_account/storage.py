"""Shadow Account persistence (~/.hyper-trading-agent/shadow_accounts/).

Layout:
    ~/.hyper-trading-agent/shadow_accounts/<shadow_id>.json   ShadowProfile
    ~/.hyper-trading-agent/shadow_runs/<shadow_id>/           backtest run dir
    ~/.hyper-trading-agent/shadow_reports/<shadow_id>.pdf     rendered report
"""
...
def _root() -> Path:
    ...
    root = Path.home() / ".hyper-trading-agent"
