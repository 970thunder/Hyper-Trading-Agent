...
This is the display name used throughout the Hyper-Trading-Agent codebase, manifests,
...
Hyper-Trading-Agent project — <https://github.com/970thunder/Hyper-Trading-Agent>
